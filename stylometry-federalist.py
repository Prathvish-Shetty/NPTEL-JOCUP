...
def read_files(filename):
    ...
    for file in filename:
        with open("C:\Users\Prathvish Shetty\CODE\Python\PyPrograms\stylometry-federalist\data\federalist_{filename}.txt") as f:
...
for author in authors:
    tokens=nltk.word_tokensize(federalist_by_author[author])
